...
from apps.portal_operation_open_api.apis.router import open_api_router
...
from apps.portal_operation_open_api.middlewares.auth_filter_middleware import AuthFilterMiddleware
...
class ServiceLauncher:
    ...
    async def startup_hook(self, app_temp: FastAPI):
        """资源初始化逻辑"""
        self.logger.info("执行服务【portal_operation_open_api】专属启动逻辑...")
    ...
    async def shutdown_hook(self, app_temp: FastAPI):
        """释放资源逻辑"""
        self.logger.info("执行服务【portal_operation_open_api】专属关闭逻辑...")
    ...
    def register_middlewares(self, app_temp: FastAPI):
        """注册中间件"""
        self.logger.info("注册【portal_operation_open_api】专属中间件")
    ...
    def create_app(self) -> FastAPI:
        ...
        app_temp = AppFactory.create_app(
            ...
            title="portal_operation_open_api",
