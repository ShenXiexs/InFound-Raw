...
from apps.portal_operation_open_api.services.security import (
    create_access_token,
    save_token_to_redis,
    verify_password,
)
...
from common.models.infound import OpsUsers
...
async def login_for_access_token(
    ...
    try:
        ...
        return success_response(data={
            "jti": jti,
            "header": app_constants.OPERATION_ACCESS_TOKEN_HEADER,
            "token": access_token,
        })
