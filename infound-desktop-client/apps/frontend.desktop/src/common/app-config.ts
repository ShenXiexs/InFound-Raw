...
export class AppConfig {
  ...
  public static readonly USER_NOTIFICATION_WS_DESTINATION_PREFIX: string = ENV.VITE_USER_NOTIFICATION_WS_DESTINATION_PREFIX || '/amq/queue/user.notification'
  public static readonly TASK_MANAGER_POLLING_INTERVAL_MS: number = Math.max(Number(ENV.VITE_TASK_MANAGER_POLLING_INTERVAL_MS || '20000') || 20000, 1000)
