...
async def prepare_id_outreach_page(
    ...
    del timeout_seconds
    service.logger.info(
        "Skipping ID outreach page pre-processing",
        account_name=account.name,
        current_url=service._page.url if service._page else None,
    )


ID_OUTREACH_FILTER_SCRIPT = OutreachFilterScript(
    region_code="ID",
    ...
    prepare_page_hook=prepare_id_outreach_page,
)
