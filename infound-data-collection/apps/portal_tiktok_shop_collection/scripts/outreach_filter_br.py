...
async def prepare_br_outreach_page(
    ...
    del timeout_seconds
    service.logger.info(
        "Skipping BR outreach page pre-processing",
        account_name=account.name,
        current_url=service._page.url if service._page else None,
    )


BR_OUTREACH_FILTER_SCRIPT = OutreachFilterScript(
    region_code="BR",
    ...
    prepare_page_hook=prepare_br_outreach_page,
)
