...
class Products(Base):
    ...
    selling_point: Mapped[Optional[str]] = mapped_column(TINYTEXT, comment='selling points')
    selling_point_cn: Mapped[Optional[str]] = mapped_column(TINYTEXT, comment='selling points (CN)')
    shooting_guide: Mapped[Optional[str]] = mapped_column(TINYTEXT, comment='shooting guidelines')
    shooting_guide_cn: Mapped[Optional[str]] = mapped_column(TINYTEXT, comment='shooting guidelines (CN)')
...
class SampleContentCrawlLogs(Base):
    ...
    platform_detail_url: Mapped[Optional[str]] = mapped_column(String(512), comment='creator platform URL')
