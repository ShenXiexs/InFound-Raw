...
class Settings(BaseSettings):
    ...
    INNER_API_CAMPAIGN_PATH: str = Field(
        default="/campaigns/ingest",
        validation_alias="INNER_API__CAMPAIGN_PATH",
    )
    INNER_API_PRODUCT_PATH: str = Field(
        default="/products/ingest",
        validation_alias="INNER_API__PRODUCT_PATH",
    )
